   ...
   <div className='bg-black scroll-smooth from-slate-900 min-h-screen overflow-hidden   text-white'>
      ...
      <div className=' fixed z-50 flex justify-center items-center inset-0 '>
        ...
        />
         ...
         <h1 className='text-center drop-shadow-lg font-bold text-3xl'>Thank You</h1>
         <p className='text-neutral-800 font-semibold'>for visiting my portfolio! 🚀</p>
         <p className='text-neutral-800 text-center font-normal'>Explore my projects and get to know more about me</p>       
